...
public class ExplicitLegacyContractUpgradeClient {

    private static final Logger logger = LoggerFactory.getLogger(ExplicitLegacyContractUpgradeClient.class);
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        ImmutableList.of(proxyRTO, proxyA, proxyB).forEach(proxy -> {
            proxy.vaultQuery(VehicleState.class).getStates()
                ...
                proxy.startFlowDynamic(ContractUpgradeFlow.Authorise.class, vehicleStateStateAndRef, VehicleContractV3.class);
            });
        });
        ...
        ImmutableList.of(proxyA, proxyB).forEach( proxy -> {
            proxy.vaultQuery(VehicleState.class).getStates()
                ...
                proxy.startFlowDynamic(ExplicitUpgradeFlow.class, vehicleStateStateAndRef, VehicleContractV3.class);
            });
        });
