...
public class RegistrationInitiatorFlow extends FlowLogic<SignedTransaction> {
    ...
    public SignedTransaction call() throws FlowException {
        ...
        //Build the output state. Null paramaters added for challanValue and challanIssuer
        final VehicleState vehicleState = new VehicleState(redgNumber, owner, rto, null, null);
        ...
        // Call finality flow to distribute the state to all the parties
