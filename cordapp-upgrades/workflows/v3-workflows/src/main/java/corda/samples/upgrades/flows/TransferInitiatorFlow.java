...
public class TransferInitiatorFlow extends FlowLogic<SignedTransaction>{
    ...
    public SignedTransaction call() throws FlowException {
        ...
        // Build the output state with the updated owner. Null paramaters added for challanValue and challanIssuer
        final VehicleState outputState = new VehicleState(inputState.getRedgNumber(), newOwner, rto, null, null);
